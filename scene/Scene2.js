class Scene2 extends Phaser.Scene{
    ...
    create() { 
        ...
        scoreText = this.add.text(25, 20, 'score: 0', { fontSize: '30px', fill: '#D2187F', fontFamily: 'Bebas Neue'});
        ...
        this.soundOff.on('pointerdown', function (){
            if(isOn){
                ...
                this.soundOff.on('pointerover',  () => this.add.image(1090, 39, 'off-hover'))
       ...
       this.diamondsPink = this.physics.add.staticGroup();
        this.diamondsPink.create(150, 240, 'diamond-rosa').setScale(.5);
        this.diamondsPink.create(670, 100, 'diamond-rosa').setScale(.5);
        this.diamondsPink.create(1050, 100, 'diamond-rosa').setScale(.5);
        this.diamondsPink.create(450, 450, 'diamond-rosa').setScale(.5);

        this.diamondsViolet = this.physics.add.staticGroup();
        this.diamondsViolet.create(630, 530, 'diamond-violeta').setScale(.5);
        this.diamondsViolet.create(680, 530, 'diamond-violeta').setScale(.5);
        this.diamondsViolet.create(730, 530, 'diamond-violeta').setScale(.5);
        
        this.diamonds = this.physics.add.staticGroup();
        this.diamonds.create(50, 240, 'diamond-celeste').setScale(.5);
        this.diamonds.create(100, 240, 'diamond-celeste').setScale(.5);
        this.diamonds.create(200, 240, 'diamond-celeste').setScale(.5);
        this.diamonds.create(320, 120, 'diamond-celeste').setScale(.5);
        this.diamonds.create(370, 120, 'diamond-celeste').setScale(.5);
        this.diamonds.create(420, 120, 'diamond-celeste').setScale(.5);
        this.diamonds.create(470, 120, 'diamond-celeste').setScale(.5);
        this.diamonds.create(620, 380, 'diamond-celeste').setScale(.5);
        this.diamonds.create(670, 380, 'diamond-celeste').setScale(.5);
        this.diamonds.create(720, 380, 'diamond-celeste').setScale(.5);
        this.diamonds.create(770, 380, 'diamond-celeste').setScale(.5);
        this.diamonds.create(780, 240, 'diamond-celeste').setScale(.5);
        this.diamonds.create(830, 240, 'diamond-celeste').setScale(.5);
        this.diamonds.create(880, 240, 'diamond-celeste').setScale(.5);
        this.diamonds.create(930, 240, 'diamond-celeste').setScale(.5);
        this.diamonds.create(980, 240, 'diamond-celeste').setScale(.5);
        this.diamonds.create(1030, 240, 'diamond-celeste').setScale(.5);
        this.diamonds.create(1080, 240, 'diamond-celeste').setScale(.5);        
        this.diamonds.create(720, 100, 'diamond-celeste').setScale(.5);        
        this.diamonds.create(530, 210, 'diamond-celeste').setScale(.5);
        this.diamonds.create(580, 210, 'diamond-celeste').setScale(.5);
        
        this.dog = this.add.sprite(970, 518, 'dog').setScale(.5);
        ...
        this.physics.add.overlap(this.kid, this.diamonds, collectCeleste, null, this);
        this.physics.add.overlap(this.kid, this.diamondsViolet, collectViolet, null, this);
        this.work = this.physics.add.overlap(this.kid, this.work, workPopUp, null, this);
        this.education = this.physics.add.overlap(this.kid, this.education, educationPopUp, null, this);
        this.skills = this.physics.add.overlap(this.kid, this.skills, skillsPopUp, null, this);
        this.awards = this.physics.add.overlap(this.kid, this.awards, awardsPopUp, null, this);
        ...
        function workPopUp () {
            ...
            let keepPlayingButton1 = this.add.sprite(340, 490, 'keep').setScale(.4)
        ...
        function educationPopUp (){
            ...
            let keepPlayingButton1 = this.add.sprite(340, 510, 'keep').setScale(.4)
    ...
    update(){
        ...
        this.iceCream.children.iterate((child) => {
            ...
            if (child.body.touching.right || child.body.blocked.right) {
                    ...
                    else if (child.body.touching.left || child.body.blocked.left) {// turn right
                        child.flipX=false
        ...
        else if (this.unicorn.body.touching.left || this.unicorn.body.blocked.left) {// turn right
        ...
        if (this.cursorKeys.up.isDown && this.kid.body.touching.down && !this.isPaused)
        {
